...
2. preprocess2.py               → 4개 필터로 전처리
3. train2.py                    → 모델 학습
4. test_inference2.py           → 추론 및 GT 비교
5. result_analysis2.py          → 학습 곡선 분석
```
...
```bash
python preprocess2.py <input_folder> [output_folder]
```
...
```bash
python preprocess2.py video                                  # processed_video/ 생성
python preprocess2.py video_shifted_m10                      # processed_video_shifted_m10/ 생성
python preprocess2.py video_shifted_m10 processed_m10        # processed_m10/ 생성
```
...
```bash
python train2.py <source> <processed_folder>
```
...
```bash
python train2.py invert_clahe processed_video_shifted_m10              # 1개 필터만 학습
python train2.py all processed_video_shifted_m10                       # 4개 필터 전체 학습
```
...
## 4. 추론 및 GT 비교 (`test_inference2.py`)
...
```bash
python test_inference2.py <model_keyword> [gt_folder] [output_folder]
```
...
```bash
python test_inference2.py 20260715_224033                                     # 기본 GT 사용
python test_inference2.py 20260715_224033 video_shifted_m10                    # 시프트된 GT 사용
python test_inference2.py 20260715_224033 video_shifted_m10 results_m10        # 결과 폴더 지정
```
...
## 5. 학습 곡선 분석 (`result_analysis2.py`)
...
```bash
python result_analysis2.py <model_keyword> [output_folder]
```
...
```bash
python result_analysis2.py 20260715_224033                           # 기본 위치에 저장
python result_analysis2.py 20260715_224033 test2_results_m10          # 결과 폴더 지정
```
...
# 2. 전처리
python preprocess2.py video_shifted_m10

# 3. 학습
python train2.py all processed_video_shifted_m10

# 4. 추론
python test_inference2.py 20260715_224033 video_shifted_m10 results_shifted

# 5. 분석
python result_analysis2.py 20260715_224033 results_shifted
```
