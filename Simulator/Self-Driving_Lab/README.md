...
> 본 프로젝트는 실험실 내 핵심 장비 4대를 네트워크(TCP/IP 소ケット)로 결합하여, <br>
> 사람이 개입하지 않고 목표 데이터(흡광도)에 도달할 때까지 실시간으로 하드웨어 제어 변수를 수정하며 자율 최적화를 수행하는
> \*\*Closed-Loop 자율 실험 오케스트레이터 시스템\*\*입니다.
